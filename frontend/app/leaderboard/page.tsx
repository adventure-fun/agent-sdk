  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950 p-6 sm:p-8">
      <div className="mx-auto max-w-6xl space-y-6">
        <section className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-6 shadow-[0_0_60px_rgba(245,158,11,0.08)]">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="space-y-2">
              <p className="text-xs uppercase tracking-[0.3em] text-amber-300/70">Hall of Legends</p>
              <h1 className="text-3xl font-bold text-amber-400 sm:text-4xl">Leaderboard</h1>
        ...
        <section className="space-y-4 rounded-2xl border border-gray-800 bg-gray-900/70 p-5">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <select
                value={classFilter}
                onChange={(event) => setClassFilter(event.target.value as LeaderboardClassFilter)}
                ...
                <tbody className="divide-y divide-gray-800 bg-gray-950/70">
                  {isLoading ? (
                    ...
                    entries.map((entry, index) => {
                      ...
                      return (
                        <tr key={entry.character_id} className="transition-colors hover:bg-gray-900/80">
