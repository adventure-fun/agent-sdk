...
import { getInventoryCapacity } from "./types.js"
import type {
  GameState,
  Action,
  TurnResult,
  ...
  return {
    ...
    character: {
      ...
      resource_percent: obs.character.resource.max > 0
        ...
        : 0,
      resource_type: obs.character.resource.type,
      resource_current: obs.character.resource.current,
      resource_max: obs.character.resource.max,
      abilities: obs.character.abilities,
    ...
    inventory_capacity: obs.inventory_capacity,
